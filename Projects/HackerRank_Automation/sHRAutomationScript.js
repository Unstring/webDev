// node sHRAutomationScript.js --url="https://www.hackerrank.com" --config=config.json
...
async function run() {
    ...
    await page.waitForSelector("a[href='/administration/contests/']", { delay: 1500});
    await page.click("a[href='/administration/contests/']", { delay: 5000 });
